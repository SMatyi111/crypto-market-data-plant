...
| Liquidations | Bybit BTC/ETH/SOL; OKX all swaps | **B** Bybit (clean, not gap-proof); **C** OKX (verdict unresolved) | Bybit 2026-09-08; OKX capture 2026-08-25 | 2 d / 16 d | raw only; OKX needs `received_at` and per-product order |
